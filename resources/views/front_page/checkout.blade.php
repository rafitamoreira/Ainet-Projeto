                        ...
                        <div class="col-lg-7 col-md-6">
                            ...
                            @if (Auth::user() != null)
                                <div class="checkout__input">
                                    ...
                                    <input type="text" placeholder="Morada" class="checkout__input__add" name="endereco1"
                                        id="endereco1" value="{{ Auth::user()->customer->address }}">
                                </div>
                            @else
                                <div class="checkout__input">
                                    <p>Endereço<span>*</span></p>
                                    <input type="text" placeholder="Morada" class="checkout__input__add" name="endereco1"
                                        id="endereco1">
                                    <input type="text" placeholder="Apartamento, Numero, ect (optinal)" name="endereco2"
                                        id="endereco2">
                                </div>
                                <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" name="nif" id="nif"
                                    @if (Auth::user() != null) value="{{ Auth::user()->customer->nif }}" @endif>
                            </div>
                            <div class="checkout__input">
                                <p>Referencia Pagamento<span>*</span></p>
                                <input type="text" name="payment_ref" id="payment_ref"
                                    @if (Auth::user() != null) value="{{ Auth::user()->customer->default_payment_ref }}" @endif>
                            </div>
                            @if (Auth::user() == null)
                                ...
                                <ul>
                                    @if (Session::has('cart'))
                                        @foreach ($items as $item)
                                            @php($cor = App\Models\Color::where('code', $item['cor'])->first())
                                            <li>{{ $item['qty'] }}x {{ $item['item']['nome'] }} /
                                                {{ $item['tamanho'] }} /
                                                {{ $cor->nome }}
